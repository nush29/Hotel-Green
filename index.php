		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">HOTEL <span>GREEN</span><p class="logo_w3l_agile_caption">Book Your Dream Resort</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#rooms" class="menu__link scroll">Features</a></li>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">HOTEL GREEN</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our HOTEL GREEN</h3> 
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					<ul class="resp-tabs-list" align="center">
					<li>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Niketh Munasinghe</h4>
							<span>Manager</span>
							<p>Effective and communicative hotel manager with 6+ years of professional experience in a dynamic environment. Eager to help The Bellevue Hotel ensure seamless daily operations and offer experience exceeding guest expectations.</p>
...
<!-- //gallery -->
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Features And Rates</h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
						<img src="images/r1.jpg" alt=" " class="img-responsive" />
							<a href="halls.php"><h4>Hall Reservation</h4></a><br>
						</div>
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						...
						<a href="rooms.php"><h4>Room Reservation</h4></a><br>
						</div>
						<div class="price-gd-bottom">
							<div class="price-list">
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						...
						<a href="events.php"><h4>Event Reservation</h4></a><br>
						</div>
						<div class="price-gd-bottom">
							<div class="price-list">
				...
				<div class="col-md-3 price-grid wthree lost">
					<div class="price-block agile">
						<div class="price-gd-top ">
							...
							<a href="foods.php"><h4>Food & Beverage</h4></a><br>
						</div>
						<div class="price-gd-bottom">
							<div class="price-list">
							</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+94 (01)222-44-55</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@HOTELGREEN.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Galle Road, Hikkaduwa, Sri Lanka</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 HOTELGREEN . All Rights Reserved | Design by <a href="index.php">HOTELGREEN</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
