                    ...
                    <div class="well">
						...
						<?php
							...
							else
							{
									...
									$check="SELECT * FROM eventbook WHERE email = '$_POST[email]'";
									...
									else
									{
										...
										$new ="Not Conform";
										$newUser="INSERT INTO `eventbook`(`title`, `fname`, `lname`, `members`, `phone`, `email`, `name`,`textbox`, `dec`, `meal`, `date`, `nic` , `stime`, `etime`) VALUES ('$_POST[title]','$_POST[fname]','$_POST[lname]','$_POST[members]','$_POST[phone]','$_POST[email]','$_POST[name]','$_POST[name]','$_POST[dec]','$_POST[meal]','$_POST[date]','$_POST[nic]' ,'$_POST[stime]','$_POST[etime]')";
