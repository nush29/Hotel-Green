        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="usersetting.php"><i class="fa fa-dashboard"></i>User Dashboard</a>
                    </li>
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==0 )
											{
												echo"<tr class='gradeC'>
													...
													<td><a href=usersettingdel.php?eid=".$id ." <button class='btn btn-danger'> Delete</button></td>
												</tr>";
											}
											else
											{
