						...
						<?php
							...
							else
							{
									...
									else
									{
										...
										$new ="Not Conform";
										$newUser="INSERT INTO `hallbook`(`title`, `fname`, `lname`, `members`, `phone`, `email`, `type`, `qty`, `meal`, `date`, `stime`, `etime`) VALUES ('$_POST[title]','$_POST[fname]','$_POST[lname]','$_POST[members]','$_POST[phone]','$_POST[email]','$_POST[type]','$_POST[qty]','$_POST[meal]','$_POST[date]','$_POST[stime]','$_POST[etime]')";
