                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Hall Managing </small>
                        </h1>
                        <div>
				<a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> New Hall</a>
			</div>
                    </div>
                </div>
<div>
					...
					<tbody>
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								include('halledit_delete_modal.php');
							}
