                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Room Managing </small>
                        </h1>
                        <div>
				<a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> New Room</a>
			</div>
                    </div>
                </div>
<div>
